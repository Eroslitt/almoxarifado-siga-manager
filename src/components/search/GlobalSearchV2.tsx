...
import { Search, List, TrendingUp, X, Mic, Camera, Filter } from 'lucide-react';
...
export const GlobalSearchV2: React.FC = () => {
    ...
    <div className={cn(
      ...
      <div className="relative">
        ...
        <Input
          ref={inputRef}
          type="text"
          placeholder={isMobile ? "Buscar..." : "Buscar ferramentas, itens, usuários... (Ctrl+K)"}
          value={query}
      ...
      {isOpen && (
        <Card className={cn(
          ...
          isMobile 
            ? "top-12 left-0 right-0 max-h-80" 
            : "top-12 left-0 right-0 max-h-96"
        )}>
          <CardContent className="p-0">
            ...
            <ScrollArea className={isMobile ? "max-h-60" : "max-h-80"}>
              {query.length === 0 ? (
                <div className="p-4">
                  <div className="mb-4">
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <Badge className={cn(getTypeColor(result.type), "text-xs")}>
                              {result.type}
                            </Badge>
                          </div>
                ...
                <div className="p-8 text-center text-gray-500">
                  ...
                  <p className={isMobile ? "text-sm" : "text-base"}>Nenhum resultado encontrado para "{query}"</p>
